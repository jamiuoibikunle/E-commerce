	...
	return (
		<main className={styles.homecontainer}>
			...
			<section className={styles.customerservice}>
				<img src={customerservice} alt='mockup2' className={styles.mockup2} data-aos='fade-right' data-aos-delay='900' />
				<aside className={styles.whyusanswers} data-aos='fade-left' data-aos-delay='1200' >
					<p className={styles.answer}>
